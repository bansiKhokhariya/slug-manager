...
class Slug extends Model
{
    ...
    public function getdatatable()
    {
        ...
        $columns = array(
            ...
            5 => DB::raw('(CASE WHEN slug.status = "A" THEN "Actived" ELSE "Deactived" END)'),
        ...
        $resultArr = $query->skip($requestData['start'])
                    ...
                    ->select('slugs.id', 'slugs_category.category', 'slugs.slug', DB::raw("CONCAT(u1.first_name,' ',u1.last_name) as addBy"),
                    DB::raw("CONCAT(u2.first_name,' ',u2.last_name) as updatedBy"), 'slugs.status')
                    ->get();
